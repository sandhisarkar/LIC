...
public bool UpdateStatus(int pStatus,Credentials prmCrd)
        ...
        public bool UpdatePolicyDetails(string prmName,string keyNo)
        {
            string sqlStr = null;
            OdbcTransaction sqlTrans = null;
            bool commitBol = true;
            ...
            sqlStr = @"insert into tbl_unicode_text values('"+ keyNo +"','"+ prmName +"')";
        ...
        public bool DeleteFromInventory()
        {
            ...
            sqlStr = "delete FROM inventory_in_exception where policy_number not in(select policy_number from policy_master where (status=36 or status=37) and proj_key = '"+ ctrlPolicy.ProjectKey +"' and batch_key='" + ctrlPolicy.BatchKey + "' and box_number='" + ctrlPolicy.BoxNumber + "')";
