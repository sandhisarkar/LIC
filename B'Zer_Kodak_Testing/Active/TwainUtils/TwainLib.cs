...
//        }
        ...
        //For enable autoscan property
        cap = new TwCapability(TwCap.CAP_AUTOSCAN, (short)1, TwType.Int16);
        rc = DScap(appid, srcds, TwDG.Control, TwDAT.Capability, TwMSG.Set, cap);
        if (rc != TwRC.Success)
        {
            CloseSrc();
    ...
    public int TransferPictures(ImageNotification imgNot, IWin32Window prmWin, ref bool isJobDone)
		{
        int retVal = 0;
