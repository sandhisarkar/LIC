...
namespace ImageHeaven
{
	partial class aeCustomExp
	{
		...
		private void InitializeComponent()
		{
			...
			this.lblPolicy.Location = new System.Drawing.Point(229, 38);
			...
			this.rdoPolicyNumberMismatch.Text = "Policy Number Mismatch";
			...
			this.rdoDifferentPolicyNo.Text = "Different Policy No";
