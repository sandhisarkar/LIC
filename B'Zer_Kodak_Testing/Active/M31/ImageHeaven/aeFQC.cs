	...
	public partial class aeFQC : Form, IMessageFilter ,StateData
	{
        ...
        private int ImportImage()
        {
            ...
            try
            {
                ...
                //ds = wPolicy.GetImportablePolicyList(state);
	                    ...
	                    for (int i = 0; i < policyLst.Items.Count; i++)
	                        {
	                            ...
	                            int imgCount = wImage.GetImageCount();
	                            imgCount++;
                                newImageName = policyNo + "_" + imgCount.ToString().PadLeft(3, '0') + "_A-Policy_bond.TIF";
                                origImageName = policyNo + "_" + imgCount.ToString().PadLeft(3, '0') + "_A.TIF";
