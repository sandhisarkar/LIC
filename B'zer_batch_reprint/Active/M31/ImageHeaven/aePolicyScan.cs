            ...
            bool success = false;
                if (blackBol == 0)
                {
					...
					if(policyList.Count>0)
					{
                        ...
                        {
                            ///Changed on 28/07/2010------------------------------------
                            DialogResult dr = MessageBox.Show("No more policies remain to be scanned, do you want to rescan this batch?", "Rescan", MessageBoxButtons.YesNo, MessageBoxIcon.Question);
