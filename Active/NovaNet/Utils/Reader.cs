...
namespace Utils
{
	...
	public class csvReader: Reader
	{
		...
		private bool PrepareSchemaFile(string prmCsvPath)
		{
			...
			prepSchema.Add("ColNameHeader","False");
			prepSchema.Add("Format","CSVDelimited");
			prepSchema.Add("Col1","SerialNo Text");
			prepSchema.Add("Col2","DivisionCode Text");
            prepSchema.Add("Col3","BranchCode Text");
            prepSchema.Add("Col4","BatchSerial Text");
            prepSchema.Add("Col5","PolicyType Text");
