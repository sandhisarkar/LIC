...
namespace ImageHeaven
{
	...
	public class ihConstants
	{
        ...
        public static string NEFT_KEY = "NEFT";
        public static string IPP_DOCUMENTS_KEY = "IPPDOCUMENTS";
        ...
        public static string NEFT_FILE = "NEFT";
        public static string IPPDOCUMENT_FILE = "IPP_documents";
