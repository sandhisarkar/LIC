...
namespace ImageHeaven
{
	...
	public partial class aePolicyScan : Form,IMessageFilter
	{
            ...
            bool success = false;
                if (blackBol == 0)
                {
					...
					if(policyList.Count>0)
					{
                        ...
                        this.Text = "Batch Scanning            " + " Project- " + lblProjectName.Text + "  Batch- " + lblBatch.Text + "  Box- " + lblBox.Text + " Current Record- " + lblCurrentPolicy.Text + " Next Record- " + lblNextPolicy.Text;
        ...
        void PrevImages()
        {
            ...
            lblPageCount.Text = policy.GetPolicyKeyNo(Convert.ToInt32(lblCurrentPolicy.Text));
