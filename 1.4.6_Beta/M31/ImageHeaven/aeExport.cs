                                ...
                                if ((lvwExportList.Items[i].SubItems[1].Text.ToString() != "0") || ((lvwExportList.Items[i].SubItems[2].Text.ToString() != "0")))
                                {
                                    ...
                                    for (int j = 0; j < dtr.Length; j++) //Loop within box for all the policies
                                    {
                                        ...
                                        if ((status != (int)eSTATES.POLICY_MISSING) && ((status != (int)eSTATES.POLICY_ON_HOLD)) && (status != (int)eSTATES.POLICY_SCANNED) && (status != (int)eSTATES.POLICY_QC) && (status != (int)eSTATES.POLICY_INITIALIZED) && (status != (int)eSTATES.POLICY_EXCEPTION) && (status != (int)eSTATES.POLICY_NOT_INDEXED) && ((status != (int)eSTATES.POLICY_EXPORTED) || chkReExport.Checked == true))
                                        {
                                            ...
                                            exportPath = appendPath + "\\" + ihConstants._EXPORT_FOLDER +  "\\" + cmbBatch.Text + "\\" + vendorCode + "_" + divisionCode + "-" + branchCode.PadRight(4, Convert.ToChar(" ")) + "-" + batchCount + "_" + versionNumber + "\\" + keyno;
                                            ...
                                            for (int propCount = 0; propCount < iDtr.Length; propCount++)
                                            {
                                                if (iDtr[propCount]["doc_type"].ToString() == ihConstants.PROPOSALFORM_FILE)
                                                {
                                                    ...
                                                    if (pgCurrent == 0)
                                                    {
                                                        ...
                                                        multiPageFileName.Add(keyno + "_" + ihConstants.PROPOSALFORM_FILE + ".pdf");
                                                        docCount++;
                                                    }
                                            ...
                                            if (img.TifToPdf(imageName,0, exportPath + "\\" + keyno + "_" + ihConstants.PROPOSALFORM_FILE + ".pdf") == false)
                                            {
                                                //exportTrans.Rollback();
                                                expBol = false;
                                                break;
                                            ...
                                            for (int propCount = 0; propCount < iDtr.Length; propCount++)
                                            {
                                                if (iDtr[propCount]["doc_type"].ToString() == ihConstants.PHOTOADDENDUM_FILE)
                                                {
                                                    ...
                                                    if (pgCurrent == 0)
                                                    {
                                                        ...
                                                        multiPageFileName.Add(keyno + "_" + ihConstants.PHOTOADDENDUM_FILE + ".pdf");
                                                        docCount++;
                                                    }
                                                    //Changed on 19/09/2009 for managing file copying problem in FQC
                                                    if (File.Exists(imagePath + "\\" + iDtr[propCount]["page_index_name"].ToString()) == false)
                                            ...
                                            if (img.TifToPdf(imageName,0, exportPath + "\\" + keyno + "_" + ihConstants.PHOTOADDENDUM_FILE + ".pdf") == false)
                                            {
                                                //exportTrans.Rollback();
                                                expBol = false;
                                                break;
                                            ...
                                            for (int propCount = 0; propCount < iDtr.Length; propCount++)
                                            {
                                                if (iDtr[propCount]["doc_type"].ToString() == ihConstants.PROPOSALREVIEWSLIP_FILE)
                                                {
                                                    ...
                                                    if (pgCurrent == 0)
                                                    {
                                                        ...
                                                        multiPageFileName.Add(keyno + "_" + ihConstants.PROPOSALREVIEWSLIP_FILE + ".pdf");
                                                        docCount++;
                                                    }
                                                    //Changed on 19/09/2009 for managing file copying problem in FQC
                                                    if (File.Exists(imagePath + "\\" + iDtr[propCount]["page_index_name"].ToString()) == false)
                                            ...
                                            if (img.TifToPdf(imageName,0, exportPath + "\\" + keyno + "_" + ihConstants.PROPOSALREVIEWSLIP_FILE + ".pdf") == false)
                                            {
                                                //exportTrans.Rollback();
                                                expBol = false;
                                                break;
                                            ...
                                            for (int propCount = 0; propCount < iDtr.Length; propCount++)
                                            {
                                                if (iDtr[propCount]["doc_type"].ToString() == ihConstants.POLICYLOANS_FILE)
                                                {
                                                    ...
                                                    if (pgCurrent == 0)
                                                    {
                                                        ...
                                                        multiPageFileName.Add(keyno + "_" + ihConstants.POLICYLOANS_FILE + ".pdf");
                                                        docCount++;
                                                    }
                                                    //Changed on 19/09/2009 for managing file copying problem in FQC
                                                    if (File.Exists(imagePath + "\\" + iDtr[propCount]["page_index_name"].ToString()) == false)
                                            ...
                                            if (img.TifToPdf(imageName,0, exportPath + "\\" + keyno + "_" + ihConstants.POLICYLOANS_FILE + ".pdf") == false)
                                            {
                                                //exportTrans.Rollback();
                                                expBol = false;
                                                break;
                                            ...
                                            for (int propCount = 0; propCount < iDtr.Length; propCount++)
                                            {
                                                if (iDtr[propCount]["doc_type"].ToString() == ihConstants.MEDICALREPORT_FILE)
                                                {
                                                    ...
                                                    if (pgCurrent == 0)
                                                    {
                                                        ...
                                                        multiPageFileName.Add(keyno + "_" + ihConstants.MEDICALREPORT_FILE + ".pdf");
                                                        docCount++;
                                                    }
                                                    //Changed on 19/09/2009 for managing file copying problem in FQC
                                                    if (File.Exists(imagePath + "\\" + iDtr[propCount]["page_index_name"].ToString()) == false)
                                            ...
                                            if (img.TifToPdf(imageName,0 ,exportPath + "\\" + keyno + "_" + ihConstants.MEDICALREPORT_FILE + ".pdf") == false)
                                            {
                                                //exportTrans.Rollback();
                                                expBol = false;
                                                break;
                                            ...
                                            for (int propCount = 0; propCount < iDtr.Length; propCount++)
                                            {
                                                if (iDtr[propCount]["doc_type"].ToString() == ihConstants.NOMINATION_FILE)
                                                {
                                                    ...
                                                    if (pgCurrent == 0)
                                                    {
                                                        ...
                                                        multiPageFileName.Add(keyno + "_" + ihConstants.NOMINATION_FILE + ".pdf");
                                                        docCount++;
                                                    }
                                                    //Changed on 19/09/2009 for managing file copying problem in FQC
                                                    if (File.Exists(imagePath + "\\" + iDtr[propCount]["page_index_name"].ToString()) == false)
                                            ...
                                            if (img.TifToPdf(imageName,0 ,exportPath + "\\" + keyno + "_" + ihConstants.NOMINATION_FILE + ".pdf") == false)
                                            {
                                                //exportTrans.Rollback();
                                                expBol = false;
                                                break;
                                            ...
                                            for (int propCount = 0; propCount < iDtr.Length; propCount++)
                                            {
                                                if (iDtr[propCount]["doc_type"].ToString() == ihConstants.ASSIGNMENT_FILE)
                                                {
                                                    ...
                                                    if (pgCurrent == 0)
                                                    {
                                                        ...
                                                        multiPageFileName.Add(keyno + "_" + ihConstants.ASSIGNMENT_FILE + ".pdf");
                                                        docCount++;
                                                    }
                                                    //Changed on 19/09/2009 for managing file copying problem in FQC
                                                    if (File.Exists(imagePath + "\\" + iDtr[propCount]["page_index_name"].ToString()) == false)
                                            ...
                                            if (img.TifToPdf(imageName,0 ,exportPath + "\\" + keyno + "_" + ihConstants.ASSIGNMENT_FILE + ".pdf") == false)
                                            {
                                                //exportTrans.Rollback();
                                                expBol = false;
                                                break;
                                            ...
                                            for (int propCount = 0; propCount < iDtr.Length; propCount++)
                                            {
                                                if (iDtr[propCount]["doc_type"].ToString() == ihConstants.ALTERATION_FILE)
                                                {
                                                    ...
                                                    if (pgCurrent == 0)
                                                    {
                                                        ...
                                                        multiPageFileName.Add(keyno + "_" + ihConstants.ALTERATION_FILE + ".pdf");
                                                        docCount++;
                                                    }
                                                    //Changed on 19/09/2009 for managing file copying problem in FQC
                                                    if (File.Exists(imagePath + "\\" + iDtr[propCount]["page_index_name"].ToString()) == false)
                                            ...
                                            if (img.TifToPdf(imageName,0 ,exportPath + "\\" + keyno + "_" + ihConstants.ALTERATION_FILE + ".pdf") == false)
                                            {
                                                //exportTrans.Rollback();
                                                expBol = false;
                                                break;
                                            ...
                                            for (int propCount = 0; propCount < iDtr.Length; propCount++)
                                            {
                                                if (iDtr[propCount]["doc_type"].ToString() == ihConstants.CLAIMS_FILE)
                                                {
                                                    ...
                                                    if (pgCurrent == 0)
                                                    {
                                                        ...
                                                        multiPageFileName.Add(keyno + "_" + ihConstants.CLAIMS_FILE + ".pdf");
                                                        docCount++;
                                                    }
                                                    //Changed on 19/09/2009 for managing file copying problem in FQC
                                                    if (File.Exists(imagePath + "\\" + iDtr[propCount]["page_index_name"].ToString()) == false)
                                            ...
                                            if (img.TifToPdf(imageName,0, exportPath + "\\" + keyno + "_" + ihConstants.CLAIMS_FILE + ".pdf") == false)
                                            {
                                                //exportTrans.Rollback();
                                                expBol = false;
                                                break;
                                            ...
                                            for (int propCount = 0; propCount < iDtr.Length; propCount++)
                                            {
                                                if (iDtr[propCount]["doc_type"].ToString() == ihConstants.CORRESPONDENCE_FILE)
                                                {
                                                    ...
                                                    if (pgCurrent == 0)
                                                    {
                                                        ...
                                                        multiPageFileName.Add(keyno + "_" + ihConstants.CORRESPONDENCE_FILE + ".pdf");
                                                        docCount++;
                                                    }
                                                    //Changed on 19/09/2009 for managing file copying problem in FQC
                                                    if (File.Exists(imagePath + "\\" + iDtr[propCount]["page_index_name"].ToString()) == false)
                                            ...
                                            if (img.TifToPdf(imageName,0, exportPath + "\\" + keyno + "_" + ihConstants.CORRESPONDENCE_FILE + ".pdf") == false)
                                            {
                                                //exportTrans.Rollback();
                                                expBol = false;
                                                break;
                                            ...
                                            for (int propCount = 0; propCount < iDtr.Length; propCount++)
                                            {
                                                if (iDtr[propCount]["doc_type"].ToString() == ihConstants.PROPOSALENCLOSERS_FILE)
                                                {
                                                    ...
                                                    if (pgCurrent == 0)
                                                    {
                                                        ...
                                                        multiPageFileName.Add(keyno + "_" + ihConstants.PROPOSALENCLOSERS_FILE + ".pdf");
                                                        docCount++;
                                                    }
                                                    //Changed on 19/09/2009 for managing file copying problem in FQC
                                                    if (File.Exists(imagePath + "\\" + iDtr[propCount]["page_index_name"].ToString()) == false)
                                            ...
                                            if (img.TifToPdf(imageName,0 ,exportPath + "\\" + keyno + "_" + ihConstants.PROPOSALENCLOSERS_FILE + ".pdf") == false)
                                            {
                                                //exportTrans.Rollback();
                                                expBol = false;
                                                break;
                                            ...
                                            for (int propCount = 0; propCount < iDtr.Length; propCount++)
                                            {
                                                if (iDtr[propCount]["doc_type"].ToString() == ihConstants.POLICYBOND_FILE)
                                                {
                                                    ...
                                                    if (pgCurrent == 0)
                                                    {
                                                        ...
                                                        multiPageFileName.Add(keyno + "_" + ihConstants.POLICYBOND_FILE + ".pdf");
                                                        docCount++;
                                                    }
                                                    //Changed on 19/09/2009 for managing file copying problem in FQC
                                                    if (File.Exists(imagePath + "\\" + iDtr[propCount]["page_index_name"].ToString()) == false)
                                            ...
                                            if (img.TifToPdf(imageName,0, exportPath + "\\" + keyno + "_" + ihConstants.POLICYBOND_FILE + ".pdf") == false)
                                            {
                                                //exportTrans.Rollback();
                                                expBol = false;
                                                break;
                                            ...
                                            for (int propCount = 0; propCount < iDtr.Length; propCount++)
                                            {
                                                if (iDtr[propCount]["doc_type"].ToString() == ihConstants.SURRENDER_FILE)
                                                {
                                                    ...
                                                    if (pgCurrent == 0)
                                                    {
                                                        ...
                                                        multiPageFileName.Add(keyno + "_" + ihConstants.SURRENDER_FILE + ".pdf");
                                                        docCount++;
                                                    }
                                                    //Changed on 19/09/2009 for managing file copying problem in FQC
                                                    if (File.Exists(imagePath + "\\" + iDtr[propCount]["page_index_name"].ToString()) == false)
                                            ...
                                            if (img.TifToPdf(imageName, 0,exportPath + "\\" + keyno + "_" + ihConstants.SURRENDER_FILE + ".pdf") == false)
                                            {
                                                //exportTrans.Rollback();
                                                expBol = false;
                                                break;
                                            ...
                                            for (int propCount = 0; propCount < iDtr.Length; propCount++)
                                            {
                                                if (iDtr[propCount]["doc_type"].ToString() == ihConstants.REVIVALS_FILE)
                                                {
                                                    ...
                                                    if (pgCurrent == 0)
                                                    {
                                                        ...
                                                        multiPageFileName.Add(keyno + "_" + ihConstants.REVIVALS_FILE + ".pdf");
                                                        docCount++;
                                                    }
                                                    //Changed on 19/09/2009 for managing file copying problem in FQC
                                                    if (File.Exists(imagePath + "\\" + iDtr[propCount]["page_index_name"].ToString()) == false)
                                            ...
                                            if (img.TifToPdf(imageName,0, exportPath + "\\" + keyno + "_" + ihConstants.REVIVALS_FILE + ".pdf") == false)
                                            {
                                                //exportTrans.Rollback();
                                                expBol = false;
                                                break;
                                            ...
                                            for (int propCount = 0; propCount < iDtr.Length; propCount++)
                                            {
                                                if (iDtr[propCount]["doc_type"].ToString() == ihConstants.SIGNATUREPAGE_FILE)
                                                {
                                                    ...
                                                    if (pgCurrent == 0)
                                                    {
                                                        ...
                                                        multiPageFileName.Add(keyno + "_" + ihConstants.SIGNATUREPAGE_FILE + ".pdf");
                                                        docCount++;
                                                    }
                                                    //Changed on 19/09/2009 for managing file copying problem in FQC
                                                    if (File.Exists(imagePath + "\\" + iDtr[propCount]["page_index_name"].ToString()) == false)
                                            ...
                                            if (img.TifToPdf(imageName,0, exportPath + "\\" + keyno + "_" + ihConstants.SIGNATUREPAGE_FILE + ".pdf") == false)
                                            {
                                                //exportTrans.Rollback();
                                                expBol = false;
                                                break;
                                            ...
                                            for (int propCount = 0; propCount < iDtr.Length; propCount++)
                                            {
                                                if (iDtr[propCount]["doc_type"].ToString() == ihConstants.OTHERS_FILE)
                                                {
                                                    ...
                                                    if (pgCurrent == 0)
                                                    {
                                                        ...
                                                        multiPageFileName.Add(keyno + "_" + ihConstants.OTHERS_FILE + ".pdf");
                                                        docCount++;
                                                    }
                                                    //Changed on 19/09/2009 for managing file copying problem in FQC
                                                    if (File.Exists(imagePath + "\\" + iDtr[propCount]["page_index_name"].ToString()) == false)
                                            ...
                                            if (img.TifToPdf(imageName,0, exportPath + "\\" + keyno + "_" + ihConstants.OTHERS_FILE + ".pdf") == false)
                                            {
                                                //exportTrans.Rollback();
                                                expBol = false;
                                                break;
                                            ...
                                            for (int propCount = 0; propCount < iDtr.Length; propCount++)
                                            {
                                                if (iDtr[propCount]["doc_type"].ToString() == ihConstants.KYCDOCUMENT_FILE)
                                                {
                                                    ...
                                                    if (pgCurrent == 0)
                                                    {
                                                        ...
                                                        multiPageFileName.Add(keyno + "_" + ihConstants.KYCDOCUMENT_FILE + ".pdf");
                                                        docCount++;
                                                    }
                                                    //Changed on 19/09/2009 for managing file copying problem in FQC
                                                    if (File.Exists(imagePath + "\\" + iDtr[propCount]["page_index_name"].ToString()) == false)
                                            ...
                                            if (img.TifToPdf(imageName, 0,exportPath + "\\" + keyno + "_" + ihConstants.KYCDOCUMENT_FILE + ".pdf") == false)
                                            {
                                                //exportTrans.Rollback();
                                                expBol = false;
                                                break;
...
//                }
		...
		private void UpdateAllPolicy(DataSet pDs)
		{
			...
			for(int i=0;i<pDs.Tables[0].Rows.Count;i++)
			{
                ...
                string path = pDs.Tables[0].Rows[i]["Export_path"].ToString();
                path = path.Replace("\\", "\\\\");
                expwPolicy.UpdateStatus(Convert.ToInt32(pDs.Tables[0].Rows[i]["status"].ToString()), path, crd);
			}
		}
        /*
                                    ...
                                    if ((status != (int)eSTATES.POLICY_MISSING) && ((status != (int)eSTATES.POLICY_ON_HOLD)) && (status != (int)eSTATES.POLICY_SCANNED) && (status != (int)eSTATES.POLICY_QC) && (status != (int)eSTATES.POLICY_INITIALIZED) && (status != (int)eSTATES.POLICY_EXCEPTION) && (status != (int)eSTATES.POLICY_NOT_INDEXED) && ((status != (int)eSTATES.POLICY_EXPORTED) || chkReExport.Checked == true))
                                    {
                                        ...
                                        for (int propCount = 0; propCount < iDtr.Length; propCount++)
                                        {
                                            if (iDtr[propCount]["doc_type"].ToString() == ihConstants.PROPOSALFORM_FILE)
                                            {
                                                ...
                                                {
                                                    docType.Add(ihConstants.PROPOSALFORM_FILE);
                                                    multiPageFileName.Add(policyNumber + "_" + ihConstants.PROPOSALFORM_FILE + ".pdf");
                                                    docCount++;
                                                }
                                                //Changed on 19/09/2009 for managing file copying problem in FQC
                                                if (File.Exists(imagePath + "\\" + iDtr[propCount]["page_index_name"].ToString()) == false)
