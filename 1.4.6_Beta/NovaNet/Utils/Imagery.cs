...
namespace NovaNet
{
	namespace Utils
	{
		...
		public interface Imagery
		{
            ...
            bool CombineTif(string[] InputFilenames, string OutputFilename);	//Combine single tif file to multi tif
            bool Close();   //Dispose the object
            bool TifToPdf(string[] InputFilenames, int pJpegQualityValue, string pPdfFileName);	//Combine single tif file to multi tif
		}
	}
}
